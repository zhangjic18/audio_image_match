from task_1 import audio_classify
from task_2 import perfect_match
...
def test_task1(root_path):
    ...
    class number:
        ...
        'yellow_block': 9
    """
    results = audio_classify(root_path)
    return results
...
def test_task2(root_path):
    ...
    """
    results = perfect_match(root_path)
    return results
...
if __name__ == "__main__":
    test_task1(root_path="../data/original_data/task1/test")
    test_task2(root_path="../data/original_data/task2/test")
    test_task3(root_path="../data/original_data/task3/test")
